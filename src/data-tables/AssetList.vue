<template>
    <div class="address-asset-list-dt">
        <f-data-table :columns="columns" :items="tokens" first-m-v-column-width="6" class="f-data-table-body-bg-color">
...
export default {
    ...
    methods: {
        async init() {
            ...
            this.tokens = result[0].filter((_item) => _item.isActive && _item.symbol !== 'NOVA');
