    ...
    <div class="epochlist">
        <template v-if="!queryError">
            <f-data-table :columns="dColumns" :items="dItems" :disable-infinite-scroll="!dHasNext" :loading="cLoading"
                :mobile-view="cMobileView" infinite-scroll fixed-header class="f-data-table-body-bg-color"
    ...
    data() {
        return {
            ...
            dColumns: [
                ...
                /*{
                    name: 'baseReward',
                    label: this.$t('epoch.total_base_reward') + ' (NOVA)',
                ...
                {
                    name: 'fee',
                    label: this.$t('epoch.total_fee') + ' (NOVA)',
                ...
                /*{
                    name: 'txReward',
                    label: this.$t('epoch.total_tx_reward') + ' (NOVA)',
