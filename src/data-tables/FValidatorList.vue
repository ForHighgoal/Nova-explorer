<template>
    <div class="validator-list-dt">
        <template v-if="!dValidatorListError">
            <f-data-table :columns="dColumns" :items="dItems" :mobile-view="cMobileView" :loading="cLoading"
                first-m-v-column-width="6" fixed-header class="f-data-table-body-bg-color">
                ...
                <template v-slot:column-name="{ value, item, column }">
                    <div v-if="column" class="row no-collapse no-vert-col-padding">
                        ...
                        <div class="col break-word">
                            {{ value }}
                            <a v-if="(item.stakerInfo ? item.stakerInfo.website || item.stakerInfo.contact : '')"
                                :href="(item.stakerInfo ? item.stakerInfo.website || item.stakerInfo.contact : '')"
                                target="_blank" rel="nofollow" class="validator-website">
                ...
                <template v-slot:column-stakerAddress="{ value, item, column }">
                    <div v-if="column" class="row no-collapse no-vert-col-padding">
                        ...
                        <div class="col break-word">
                            ...
                            <router-link :to="{ name: 'validator-detail', params: { address: value } }" :title="value">{{ value
