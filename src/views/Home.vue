    ...
    <div class="view-home ">
        <div class="row">
            <div class="col-8 offset-2 col-10-lg offset-1-lg col-12-sm no-offset-sm">
                <p class="serarch-heading">WELCOME TO NOVA</p>
                ...
                <div class="col-6" style="width:50%">
                    <f-card class="half-padding">
                        ...
                        <div class="home-table-in">
                            ...
                            <home-block-list :items="blocksData" :hidden-columns="['time', 'fee']" :items-per-page="10"
                                class="home-table" />
                ...
                <div class="col-6" style="width:50%">
                    <f-card class="half-padding">
                        <div class="home-table-in">
                            ...
                            <home-transaction-list :items="blocksData" :hidden-columns="['gasUsed']" :items-per-page="5"
                                class="home-table" />
                            <router-link :to="{ name: 'transactions' }" class="btn small btn_block_bottom"
                                style="width: 100%;">
                ...
                <div class="col">
                    <f-card class="half-padding">
                        <div class="home-table-in">
                            ...
                            <f-listbox v-model="txVolumesResolution" :focus-item-on-focus="true"
                                :data="txVolumesResolutions" labeled-by="txv" horizontal />
...
<style lang="scss"> .view-home .home-table-in {
     background: #eaeaea !important;
 }

 .dark-theme .view-home .home-table-in {
 ...
 .view-home .home-block h2 {
     display: flex
 }

 .view-home .home-block .num {
     color: #fff
 }
 ...
 .dark-theme .home-table-bottom {
     background: linear-gradient(to bottom, #7c1313, #0d0d0d);
     border-radius: 5px;
     text-align: center;
     padding: 25px 0;
 }
 ...
 .home-table-bottom {
     background: linear-gradient(to bottom, #c45a5a, #fff);
     border-radius: 5px;
     text-align: center;
     padding: 25px 0;
 }

 .home-table-bottom .col-8,
 .home-table-bottom .col-2 {
     text-align: center;
 }
 ...
 .f-data-table .mobile-view .mobile-item {
     background: none !important;
     padding: 20px
 }

 .f-navigation nav ul li:last-child {
