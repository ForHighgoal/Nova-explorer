<template>
    <div class="f-crypto-symbol">
        <span class="img" :style="{ width: imgWidth, height: imgHeight }">
            ...
            <img v-else-if="token.logoUrl || token.logoURL" :src="token.logoUrl || token.logoURL" class="not-fluid"
...
<script>
import novaIcon from '../../../assets/svg/tokens/NOVA.png';
import wnovaIcon from '../../../assets/svg/tokens/wNOVA.png';
