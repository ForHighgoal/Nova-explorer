<template>
    <ul class="f-social-media-links no-markers">
        <li>
            <a href="https://t.co/rUA9BE8kf2?amp=1" target="_blank" rel="nofollow" title="NOVA on Discord">
                <icon data="@/assets/svg/social-media/discord.svg" width="24" height="24"></icon>
            </a>
        </li>
        <li>
            <a href="https://twitter.com/NOVAFDN" target="_blank" rel="nofollow" title="NOVA on Twitter">
                <icon data="@/assets/svg/social-media/twitter.svg" width="24" height="24"></icon>
            </a>
        </li>
        <li>
            <a href="https://www.reddit.com/r/NOVAFoundation/" target="_blank" rel="nofollow" title="NOVA on Reddit">
                <icon data="@/assets/svg/social-media/reddit.svg" width="24" height="24"></icon>
            </a>
        </li>
        <li>
            <a href="https://github.com/NOVA-Foundation" target="_blank" rel="nofollow" title="NOVA on Github">
                <icon data="@/assets/svg/social-media/github.svg" width="24" height="24"></icon>
            </a>
        </li>
        <li>
            <a href="https://medium.com/NOVAfoundation" target="_blank" rel="nofollow" title="NOVA on Medium">
                <icon data="@/assets/svg/social-media/medium.svg" width="24" height="24"></icon>
            </a>
        </li>
        <li>
            <a href="https://www.linkedin.com/company/NOVA-foundation/" target="_blank" rel="nofollow"
                title="NOVA on Linkedin" class="linkedin">
