    ...
    <header class="f-header" :class="cCssClass">
        <div class="">
            <div class="row no-collapse align-items-center">
                ...
                <div class="col right-col">
                    ...
                    <f-hamburger-switch thickness="2" two-lines @hamburger-switch-on="onHamburgerSwitchOn"
                        @hamburger-switch-off="onHamburgerSwitchOff"></f-hamburger-switch>
                </div>
            </div>
        </div>
        ...
        <div class="f-drawer" @click="onDrawerClick">
            ...
            <div class="footer">
                ...
                <div class="copyright">
                    <a href="http://novachain.org" target="_blank" rel="nofollow">©2021 novachain.org</a>
                </div>
            </div>
        </div>
    </header>
...
<style lang="scss">
.dark-theme .f-header {
    background: var(--f-header-background-color) !important;
}
