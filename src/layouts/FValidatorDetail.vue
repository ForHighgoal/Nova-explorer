        ...
        <template v-if="!dStakerByAddressError">
            <f-card>
                    ...
                    <div class="col">
                        <div v-show="cStakerName">
                            <div class="validator-img">
                                ...
                                <img v-else src="/logo.png" alt="nova logo" class="not-fluid">
                            </div>

                            {{ cStakerName }}

                            <a v-if="cStakerWebsite" :href="cStakerWebsite" target="_blank" rel="nofollow"
                ...
                <div class="row no-collapse">
                    ...
                    <div class="col">
                        <div class="break-word">{{ address }}</div>
                    </div>
                </div>
                ...
                <div class="row no-collapse">
                    ...
                    <div class="col">
                        <div v-show="'stake' in cStaker">
                            {{ formatNumberByLocale(numToFixed(WEIToGLXY(cStaker.stake), 0)) }} NOVA
                        </div>
                    </div>
                </div>
                ...
                <div class="row no-collapse">
                    ...
                    <div class="col">
                        <div v-show="'delegatedMe' in cStaker">
                            {{ formatNumberByLocale(numToFixed(WEIToGLXY(cStaker.delegatedMe), 0)) }} NOVA
                        </div>
                    </div>
                </div>
                ...
                <div class="row no-collapse">
                    ...
                    <div class="col">
                        <div v-show="'totalStake' in cStaker">
                            {{ formatNumberByLocale(numToFixed(WEIToGLXY(cStaker.totalStake), 0)) }} NOVA
                        </div>
                    </div>
                </div>
            ...
            <div class="f-subsection">
                <h2 class="h1">{{ $t('view_validator_detail.delegations') }} <span v-if="dDelegationListRecordsCount"
                        class="f-records-count">({{ dDelegationListRecordsCount }})</span></h2>

                <f-delegation-list :staker-id="cStaker.id" @records-count="onDelegationListRecordsCount" />
            </div>
        </template>
        <template v-else>
