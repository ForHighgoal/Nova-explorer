                    ...
                    <div class="balance center-v">
                        <h3 class="h1">
                            <span v-show="cAccount">
                                <MyTokenValue :value="cAccount ? cAccount.totalValue : 1" convert no-currency /> <span
                                    class="nova">NOVA</span>
                            </span>
                        </h3>
                        <div v-show="cAccount" class="usd">
                            <MyTokenValue :value="toUSD(cAccount ? cAccount.totalValue : 1)" with-price-currency
                                no-currency />
                        </div>
                    </div>
                </f-card>
                    ...
                    <div class="balance center-v">
                        <h3 class="h1">
                            <span v-show="'available' in cAssets">
                                <MyTokenValue :value="cAssets.available" convert no-currency /> <span
                                    class="nova">NOVA</span>
                            </span>
                        </h3>
                    ...
                    <div class="row no-collapse">
                        ...
                        <div class="col">
                            <div v-show="'delegated' in cAssets">
                                <MyTokenValue :value="cAssets.delegated" />
                            </div>
                        </div>
                    </div>
                    <div class="row no-collapse">
                        ...
                        <div class="col">
                            <div v-show="'pending_rewards' in cAssets">
                                <MyTokenValue :value="cAssets.pending_rewards" />
                            </div>
                        </div>
                    </div>
                    <div class="row no-collapse">
                        ...
                        <div class="col">
                            <div v-show="'stashed' in cAssets">
                                <MyTokenValue :value="cAssets.stashed" convert />
                            </div>
                        </div>
                    </div>
                    <div class="row no-collapse">
                        ...
                        <div class="col">
                            <div v-show="'claimed_rewards' in cAssets">
                                -
                                <!--{{ toGLXY(cAssets.claimed_rewards, true) }} NOVA-->
                            </div>
                        </div>
                    </div>
                    <div class="row no-collapse">
                        ...
                        <div class="col">
                            <template v-if="validators && validators.length">
                                <div v-for="validator in validators" :key="validator.id">
                                    <router-link v-if="validator.stakerAddress"
                                        :to="{ name: 'validator-detail', params: { address: validator.stakerAddress } }">
        ...
        <div class="f-subsection">
            <f-tabs>
                ...
                <f-tab title-slot="transactions">
                    <f-transaction-list :items="cTransactionItems" :loading="cLoading" :address-col="id"
                        @fetch-more="onFetchMore"></f-transaction-list>
                </f-tab>
                ...
                <f-tab title-slot="assets">
                    <address-asset-list :tokens="tokens" :f-mint-account="fMintAccount"
                        @records-count="onAssetsRecordsCount" />
                </f-tab>
                <f-tab title-slot="delegations">
                    <address-delegation-list v-if="this.loadDelegations" :account-address="id"
        ...
        return {
            ...
            /*
                            dAssetColumns: [
                                ...
                                {
                                    name: 'valueInGLXY',
                                    label: this.$t('view_address_detail.value_in_nova'),
                                    cssClass: 'align-end',
                                },
                                {
                                    name: 'valueInUSD',
