...
export class DeFi {
    ...
    _setTokens(_tokens) {
        ...
        this.novaToken = _tokens.find((_item) => _item.symbol === 'NOVA');
    ...
    */
    ...
    canTokenBeDeposited(_token) {
        return _token && _token.isActive && _token.canDeposit && _token.symbol !== 'NOVA';
    }
    ...
    canTokenBeTraded(_token) {
        ...
        return _token && _token.isActive && (_token.canTrade || _token.symbol === 'NOVA');
